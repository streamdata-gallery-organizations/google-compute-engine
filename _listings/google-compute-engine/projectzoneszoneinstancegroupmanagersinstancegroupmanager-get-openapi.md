...
x-complete: 0
info:
  title: Google Compute Engine API Get Zone Instance Group Manager
...
paths:
  ...
  /{project}/zones/{zone}/instanceGroupManagers:
    get:
      ...
      x-api-path-slug: projectzoneszoneinstancegroupmanagers-get
      parameters:
      - in: query
        name: filter
        description: Sets a filter expression for filtering listed resources, in the
    ...
    post:
      ...
      x-api-path-slug: projectzoneszoneinstancegroupmanagers-post
      parameters:
      - in: body
        name: body
        schema:
  ...
  /{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}:
    delete:
      ...
      x-api-path-slug: projectzoneszoneinstancegroupmanagersinstancegroupmanager-delete
      parameters:
      - in: path
        name: instanceGroupManager
    ...
    get:
      ...
      x-api-path-slug: projectzoneszoneinstancegroupmanagersinstancegroupmanager-get
      parameters:
      - in: path
        name: instanceGroupManager
        description: The name of the managed instance group
