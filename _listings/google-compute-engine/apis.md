...
- name: Google Compute Engine API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-compute-engine/master/_listings/google-compute-engine/project-zones-zone-targetinstances-targetinstance-get.md
x-common:
- type: x-code
